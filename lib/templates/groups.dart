...
class GroupsScreen extends StatefulWidget {
  ...
  GroupsScreen([this._title, this._body, this._orgs]);

  @override
  _GroupsScreenState createState() => _GroupsScreenState(_title, _body, _orgs);
}
...
class _GroupsScreenState extends State<GroupsScreen> {
  ...
  _GroupsScreenState(this._title, this._body, this._orgs);
