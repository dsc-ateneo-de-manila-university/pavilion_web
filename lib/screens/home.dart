...
import 'package:pavilion_web/screens/bodies/sanggu.dart';
...
import 'package:pavilion_web/screens/bodies/lions.dart';
import 'package:pavilion_web/screens/orgs/lions/dsc.dart';
import 'dart:math';
...
class HomeScreen extends StatefulWidget {
  ...
  HomeScreen([this.copList, this.groupList, this.orgList]);

  @override
  _HomeScreenState createState() =>
      _HomeScreenState(copList, groupList, orgList);
}
                          ...
                          GestureDetector(
                              onTap: () {
                                Navigator.push(
                                  ...
                                  PageTransition(
                                    type: PageTransitionType.rightToLeft,
                                    child: GroupsScreen("COP", "COP", copList),
                                  ),
                                );
                              },
                              child: Container(
                          ...
                          GestureDetector(
                            onTap: () {
                              Navigator.push(
                                ...
                                PageTransition(
                                  type: PageTransitionType.rightToLeft,
                                  child: GroupsScreen("Student Groups",
